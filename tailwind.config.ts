  ...
  theme: {
    extend: {
      colors: {
        ...
        "dopa-green":  "var(--accent-green)",
        "dopa-cyan":   "var(--accent-cyan)",
        "dopa-violet": "var(--accent-purple)",
        "dopa-red":    "var(--accent-red)",
        "dopa-xp":     "var(--accent-orange)",
        "dopa-blue":   "var(--accent-blue)",
      },
      fontFamily: {
