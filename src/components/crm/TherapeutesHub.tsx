...
const SEED: Lead[] = [
  ...
  { id: "t5", nom: "Nathalie Varlet", spe: "Fasciatherapie, cranio-sacral, constellation systemique", ville: "Ibiza", statut: "rdv_fait", rdv: "Appel fait 29/06 - relance echeancier sous 24h", contact: "WhatsApp +33 6 78 70 62 99 - nathalievarlet.com", source: "Post FB", notes: "Appel decouverte fait le 29/06, PAS close. Objection = tresorerie (elle sort deja 1800 EUR pour un podcast cet ete), mais elle valide la valeur (pas un non). Relance WhatsApp sous 24h : acompte 470 EUR maintenant + solde 470 EUR en septembre, le podcast devient le declencheur pour agir. Pas de maquette. Hors coeur de niche -> 1 relance carree puis lacher.", caContracte: 0, caCollecte: 0, rdvFait: true },
  ...
  { id: "t14", nom: "Alicia Sheherazade", spe: "Psychopraticienne ACP", ville: "Cestas (Bordeaux)", statut: "rdv_booke", rdv: "Mardi 30/06 15h30 (visio)", contact: "Messenger", source: "Post FB", notes: "Deja 5e sur Google (une base existe). Angle de qualif : etre 5e = passer derriere 4 consoeurs qui captent les prises de contact, et attirer des visiteurs != les transformer en RDV (conversion). Lien visio 5 min avant.", caContracte: 0, caCollecte: 0 },
  ...
  { id: "t16", nom: "Audrey (Hyper Essentielles)", spe: "Consultante bilan de competences (hors niche coeur)", ville: "Ay-Champagne / Epernay (51)", statut: "chaud", rdv: "Mardi 30/06 18h (a confirmer)", contact: "Messenger - hyperessentielles.fr", source: "Post FB", notes: "Inbound. Clients via bouche-a-oreille + reco, rien via Google = la marge. Hors niche coeur (bilan de competences, souvent finance CPF). Creneau 18h propose, en attente de confirmation. Checker sa presence Google avant le RDV.", caContracte: 0, caCollecte: 0 },
