  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto flex flex-col gap-6 px-7 py-6">
        ...
        {/* Timer Zone */}
        <div className="flex flex-col items-center gap-6 py-4 rounded-3xl relative bg-surface border border-b-primary"
        ...
        >
          ...
          <div className="flex gap-2 flex-wrap justify-center">
            ...
            <div className="flex items-center gap-1.5 px-3 py-2 rounded-3xl border border-b-primary"
          ...
          <div className="flex gap-2 flex-wrap justify-center">
            {NOISES.map((n) => (
              <button
                ...
                className="text-[13px] px-3 py-1.5 rounded-xl font-medium transition-all flex items-center gap-1.5 border border-b-primary"
                style={{
                  background:
            ...
            {showBreakPrompt && (
              ...
              >
                ...
                <div className="flex gap-2 justify-center">
                  ...
                  <button
                    onClick={skipBreak}
                    className="px-4 py-2 rounded-xl text-xs font-medium transition-all border border-b-primary"
                    style={{
            ...
            {showHistory && (
              ...
              >
                ...
                {hyperfocusSessions.slice(0, 15).map((s) => (
                  <div
                    key={s.id}
                    className="flex items-center gap-3 px-4 py-2.5 rounded-3xl bg-surface border border-b-primary"
                  >
                    <div className="w-7 h-7 rounded-xl flex items-center justify-center shrink-0 bg-accent-blue-light border border-b-primary"
                    >
